" Borrowed from https://github.com/m-ou-se/config/blob/master/vim/colors/custom.vim
...
hi LineNr        cterm=none ctermfg=240 ctermbg=Black
...
hi Whitespace    cterm=none ctermfg=235
